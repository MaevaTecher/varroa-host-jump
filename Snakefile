...
rule IMa2p:
	...
	output: outDir + "/ima2/runall/144l_36i_run1.out"
	shell:
		"""
		/apps/unit/MikheyevU/Maeva/IMgui-linux-x64/resources/app/IMa/IMa2 -b 10000 -l 10000 -hfg -hn 5 -ha 0.99 -hb 0.3 -i{input} -o{output} -q 50 -m 100 -t 200
		"""
